...
import { i as ChevronDown, r as Microscope, t as User } from "../_libs/lucide-react.mjs";
import { n as defu } from "../_libs/defu.mjs";
import { a as PACKAGE_VERSION, i as GENERIC_OAUTH_ERROR_CODES, o as getBaseURL, r as hasGateSessionMarker } from "./router-RWAYoLf4.mjs";
import { a as atom, i as onSet, n as STORE_UNMOUNT_DELAY, r as onMount, t as listenKeys } from "../_libs/nanostores.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/page-shell-BSFu5CLz.js
...
function AdBanner({ label = "Advertisement" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
		className: "border-b border-line bg-ad",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex max-w-6xl items-center justify-center gap-3 px-4 py-3",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "rounded-sm border border-line bg-paper-2 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-muted",
				children: label
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-center text-sm text-muted",
				children: "Premium placement — sponsor this list"
			})]
		})
	});
}
function Logo({ compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-white",
				children: compact ? ".com" : "atchlist.com"
			})
		]
	});
}
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: "sticky top-0 z-40 bg-ink text-white",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			ref: wrapRef,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: ["More ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "size-3.5 opacity-70" })]
							}), moreOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "absolute left-0 top-[calc(100%+6px)] min-w-52 overflow-hidden rounded-lg bg-paper-2 py-1 text-fg shadow-[0_12px_32px_rgba(0,0,0,0.22)]",
								children: moreLinks.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: l.to,
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: "absolute right-0 top-[calc(100%+6px)] min-w-48 overflow-hidden rounded-lg bg-paper-2 py-1 text-fg shadow-[0_12px_32px_rgba(0,0,0,0.22)]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: "Search this list"
						})]
					}) : null]
				}), isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "size-10 animate-pulse rounded-full bg-white/10" }) : user ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "max-w-[180px] truncate pl-1 [&_button]:text-white/80 [&_span]:text-white",
					...
					}), userOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute right-0 top-[calc(100%+6px)] min-w-44 overflow-hidden rounded-lg bg-paper-2 py-1 text-fg shadow-[0_12px_32px_rgba(0,0,0,0.22)]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/login",
							className: "block px-4 py-2.5 text-sm hover:bg-paper",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				className: "border-t border-line py-8 text-center text-xs text-muted",
				children: "AssetWatchlist.com — independent research notes. Not investment advice."
			})
		]
	});
}
//#endregion
export { authClient as n, signIn as r, PageShell as t };
