...
function BullishPage() {
  const rows = august30.filter((a) => a.expectedMove === "Bullish");

  return (
    <PageShell>
      <header className="mb-6 border-b border-black pb-4">
        <h1 className="font-serif text-2xl font-semibold text-bull">Bullish calls</h1>
        <p className="mt-1 text-sm text-muted">Names currently marked bullish on today's desk list.</p>
      </header>
